...
*** 例: ~graph-plot.r~
    #+begin_src R :file figs/graph-plot1.png :width 600 :height 600 :exports both :results graphics :session slide04
      ### ベクトルの描画
      plot(11:20)
    #+end_src
    # #+CAPTION: ベクトルの描画
...
*** 関数 ~plot()~ 
    ...
    - 別の関数 ~f~ を重ね書きする場合は以下を実行する
      #+begin_src R :exports code
	curve(f, add=TRUE, ...)            
      #+end_src

*** 例: ~graph-plot.r~
    #+begin_src R :file figs/graph-plot2.png :width 600 :height 600 :exports both :results graphics :session slide04
      ### 関数の描画
      plot(sin, 0, 4*pi, 
	   col="blue", # グラフの線の色
	   lwd=2, # グラフの線の太さ
...
*** 例: ~graph-plot.r~
    #+begin_src R :file figs/graph-plot3.png :width 600 :height 600 :exports both :results graphics :session slide04
      ### データ点の描画
...
*** 例: ~graph-plot.r~
    #+begin_src R :file figs/graph-plot4.png :width 600 :height 600 :exports both :results graphics :session slide04
...
** 演習
   ...
   - 前回配布した県別のデータ ~jpdata~ を用いて婚姻・離婚率の散布図を描画せよ．
     ...
     - 読み込み方は以下を参照．
       #+begin_src R :exports code 
	 jpdat <- read.csv(file="jpdata1-sjis.csv",fileEncoding="sjis",row.names=1)
	 jpval <- read.csv(file="jpdata2-sjis.csv",fileEncoding="sjis")
	 jpreg <- read.csv(file="jpdata3-sjis.csv",fileEncoding="sjis")
       #+end_src
...
*** 例: ~graph-legend.r~
    #+begin_src R :file figs/graph-legend.png :width 600 :height 600 :exports both :results graphics :session slide04
      ### 凡例の追加
...
*** ~graph-font.r~
    #+begin_src R :file figs/graph-font.png :width 600 :height 600 :exports both :results graphics :session slide04
      ### 日本語フォントの指定
      par(family = "HiraginoSans-W4") 
      ### 2018年の東京の気候データによる例
      mydat <- read.csv("example/tokyo_weather_2018_sjis.csv",
			fileEncoding="sjis")
      ## 月ごとの平均をプロットする
...
*** 例: ~graph-hist.r~
    #+begin_src R :file figs/graph-hist1.png :width 600 :height 600 :exports both :results graphics :session slide04
      ### 関数histによるヒストグラムの作図
      mydat <- read.csv("example/tokyo_weather_2018_sjis.csv", 
			fileEncoding="sjis")
      par(family = "HiraginoSans-W4") 
...
*** 例: ~graph-hist.r~
    #+begin_src R :file figs/graph-hist2.png :width 600 :height 600 :exports both :results graphics :session slide04
      ### 関数histによるヒストグラムの作図
      mydat <- read.csv("example/tokyo_weather_2018_sjis.csv",
			fileEncoding="sjis")
      par(family = "HiraginoSans-W4") 
...
*** 例: ~graph-boxplot.r~
    #+begin_src R :file figs/graph-boxplot1.png :width 600 :height 600 :exports both :results graphics :session slide04
      ### 関数boxplotによる箱ひげ図の作図
      mydat <- read.csv("example/tokyo_weather_2018_sjis.csv",
			fileEncoding="sjis")
      par(family = "HiraginoSans-W4") 
...
*** 例: ~graph-boxplot.r~
    #+begin_src R :file figs/graph-boxplot2.png :width 600 :height 600 :exports both :results graphics :session slide04
      ### 関数boxplotによる箱ひげ図の作図
      mydat <- read.csv("example/tokyo_weather_2018_sjis.csv",
			fileEncoding="sjis")
      par(family = "HiraginoSans-W4") 
...
*** 例: ~graph-barplot.r~
    #+begin_src R :file figs/graph-barplot1.png :width 600 :height 600 :exports both :results graphics :session slide04
      ### 関数barplotによる棒グラフの作図
      mydat <- read.csv("example/tokyo_weather_2018_sjis.csv",
			fileEncoding="sjis")
      par(family = "HiraginoSans-W4") 
...
*** 例: ~graph-barplot.r~
    #+begin_src R :file figs/graph-barplot2.png :width 600 :height 600 :exports both :results graphics :session slide04
      ### 関数barplotによる棒グラフの作図
      ### 複数の棒グラフ
      par(family = "HiraginoSans-W4") 
...
*** 例: ~graph-pie.r~
    #+begin_src R :file figs/graph-pie.png :width 600 :height 600 :exports both :results graphics :session slide04
      ### 関数pieによる円グラフの作図
      mydat <- read.csv("example/tokyo_weather_2018_sjis.csv",
			fileEncoding="sjis")
      par(family = "HiraginoSans-W4") 
...
*** 例: ~graph-pairs.r~
    #+begin_src R :file figs/graph-pairs.png :width 600 :height 600 :exports both :results graphics :session slide04
      ### 関数pairsによる散布図の作図
      mydat <- read.csv("example/tokyo_weather_2018_sjis.csv",
			fileEncoding="sjis")
      par(family = "HiraginoSans-W4") 
...
*** 例: ~graph-plot3d.r~
    #+begin_src R :file figs/graph-plot3d1.png :width 600 :height 600 :exports both :results graphics :session slide04
      ### 関数perspによる2変数関数の俯瞰図
...
*** 例: ~graph-plot3d.r~
    #+begin_src R :file figs/graph-plot3d2.png :width 600 :height 600 :exports both :results graphics :session slide04
